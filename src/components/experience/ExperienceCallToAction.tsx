...
export const ExperienceCallToAction: React.FC<ExperienceCallToActionProps> = ({ isDark }) => {
  return (
    <div className={`rounded-2xl p-8 text-center ${
      ...
      <p className={`text-lg mb-8 max-w-2xl mx-auto ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>
        Ready to bring your project to life? Let's discuss how my experience can help you achieve your goals.
      </p>
