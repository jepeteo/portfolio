...
import { Calendar, ExternalLink, Award, Users, ChevronDown, ChevronUp } from 'lucide-react'
    ...
    >
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          {/* Level Badge */}
          <div className={`px-3 py-1 rounded-full text-xs font-medium border ${getLevelColor(certificate.level || 'Intermediate')}`}>
        ...
        {certificate.skills && certificate.skills.length > 0 && (
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              {certificate.skills.slice(0, isExpanded ? undefined : 6).map((skill, index) => (
                <span
                  key={index}
